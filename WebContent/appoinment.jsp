...
<h1 align="center" style="margin-top: 10%;    width: 41%;">Doctor Appoinment Process... </h1>
	<br>
			...
			<form action="SendRequest" method="post">
			  <input type="submit" value="Send Request" class="button" style="margin-left: 42%;">
           ...
           <%--  <i><h2><%=request.getAttribute("msg")%></h2></i> --%>
