...
<body>
            ...
            <div class="container">
                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Skin Disease</a>
                    </div>
	...
	<div >
		...
		<img src="data:image/jpg;base64, <%=b64%>" style="border-radius: 22px; height: 250px; width:250px; margin-left: -29%;     margin-left: -23%;"  alt="Visruth.jpg not found" align="left"  />&nbsp;
...
%>
<p class="formfield" vertical-align="middle" ><font color: "#191970" style="margin-left: -15%;font-family: Lobster, serif;font-size: 40px; ">Disease Predicted:</font>
<textarea name="food" rows="2" cols="30" font style="font-family:Yu Gothic UI;font-size:20px; color:#191970;    margin-top: -25%;
    margin-left: 39%;"><%=dis%> </textarea> </p>
    ...
    <%
   //String iid=(String)session.getAttribute("imageId");
