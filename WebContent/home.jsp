        ...
        <div id="top" class="starter_container1 bg">
            <div class="follow_container">
                <div class="col-md-6 col-md-offset-3">
                    <h2 class="top-title" style=margin-top:120px;>Face Skin Disease</h2>
            ...
            <div class="text-content container">
                ...
                <div class="col-md-6">
                    <div class="img-section">
                       <img src="images/10.jpg" width="250" height="220">
                       <img src="images/28.jpg" width="250" height="220">
                       <div class="img-section-space"></div>
                       <img src="images/15.jpg"  width="250" height="220">
