                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                            ...
                            <li><a class="navactive color_animation" href="user.jsp">USER</a></li>
                            <li><a class="navactive color_animation" href="doctor.jsp">DOCTOR</a></li>
        ...
        <div id="top" class="starter_container bg">
            <div class="follow_container">
                <div class="col-md-6 col-md-offset-3">
                    <h2 class="top-title">Face Skin Disease</h2>
                    <h2 class="white second-title">" Best in Services "</h2>
                    <hr>
                </div>
            </div>
        </div>
            ...
            <div class="text-content container">
                ...
                <div class="col-md-6">
                    <div class="img-section">
                       <img src="images/37.jpg" width="250" height="220">
                       <img src="images/38.jpg" width="250" height="220">
                       <div class="img-section-space"></div>
                       <img src="images/39.jpg"  width="250" height="220">
                       <img src="images/5.jpg"  width="250" height="220">
                   </div>
                </div>
            </div>
        </section>
