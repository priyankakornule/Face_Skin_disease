...
<body>
        ...
        <link rel="stylesheet" href="css/main3.css" media="screen" type="text/css">
...
%>
        ...
        <div id="top" class="starter_container7 bg">
            <div class="follow_container">
                <div class="col-md-6 col-md-offset-3">
                  <form action="Predicition" method="post">
<h3 style="font-family: Lobster, serif; text-align: center; font-size: 60px; color: #191970; ">Prediction....... </h3>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;<input type="submit" name="imgid" value="Processing..." style="background: #0AC986;">
            ...
            <div class="text-content container">
                ...
                <div class="col-md-6">
                    <div class="img-section">
                       <img src="images/105.jpg" width="250" height="220">
                       <img src="images/102.jpg" width="250" height="220">
                       <div class="img-section-space"></div>
                       <img src="images/104.jpg"  width="250" height="220">
                       <img src="images/11.jpg"  width="250" height="220">
                   </div>
                </div>
            </div>
        </section>
