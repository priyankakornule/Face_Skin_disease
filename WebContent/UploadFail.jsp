...
%>
		...
		<h style="font-family:Candara; font-size:55px; color:#ff1a1a;margin-top: -6%;">Upload Failed... Try Again..</h><br> 
		

		<a style="font-family:auto;font-size:30px;color:white "href="uploadImage.jsp">Click here to Upload again</a>
	</center>
                    <hr>
                </div>
            </div>
