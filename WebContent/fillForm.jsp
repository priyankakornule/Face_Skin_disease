...
<h1 align="center" style="margin-top: 10%">Appoinment Fix Form</h1>
	<br>
	
	
				<br> 

			<form action="fillFormController" method="post">
				<table border="2"
			     ...
			     <input type="hidden" value="<%=first%>" name="fname">
			     <input type="hidden" value="<%=last%>" name="lname">
			     <input type="hidden" value="<%=pred%>" name="dis">
