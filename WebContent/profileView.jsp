                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                            <li><a class="navactive color_animation" href="home.jsp">HOME</a></li>
                             ...
                             <li><a class="navactive color_animation" href="uploadImage.jsp">ULPOAD IMAGE</a></li>
...
<div class="container bootstrap snippet">
    ...
    <div class="panel panel-default">
         ...
         <%--  <div class="col-sm-10" style="margin-left:512px; margin-top: 25%">
  		<h1 style="font-family: serif; font-size: 40px; color: initial;"><%=s.getFname()+" "+s.getLname()%></h1></div> --%>
        
          
        </div><!--/col-3-->
    	<div class="col-sm-9" style="display:inherit; margin-left: 63%; width: 60%;     margin-top: 4%;  	">
            <!-- <ul class="nav nav-tabs">
                <li class="active"><a style="font-family: serif; font-size: 18px; color:black" data-toggle="tab" href="#home">User Uploaded Whole Day Image Calorie:</a></li>
        ...
        <div class="tab-content" style=" background-color: aliceblue;">
            <div class="tab-pane active" id="home" style="    margin-top: -7%; ">
                <hr>
                   ...
                   <form action="ReportDownload" method="post">   
                    ...
                    <div class="form-group">
                          ...
                          <div  class="col-xs-6">
                              ...
                              <input type="text" name="fname" style="font-family: serif; font-size: 15px; color: black;"  value="<%=s.getFname()%>" placeholder="first name"  disabled>
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div >
                            <label for="last_name"><h4>Last name:</h4></label>
                              <input type="text" name="lname" style="font-family: serif; font-size: 15px;color: black;"  value="<%=s.getLname()%>" placeholder="last name" title="enter your last name if any." disabled>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div  class="col-xs-6">
                              ...
                              <input type="text" name="number" style="font-family: serif; font-size: 15px;color: black;" value="<%=s.getContact()%>" id="phone" placeholder="enter phone" title="enter your phone number if any." disabled>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div>
                              ...
                              <input type="text" name="email" style="font-family: serif; font-size: 15px; color: black;" value="<%=s.getEmail()%>" id="email" placeholder="you@email.com" title="enter your email." disabled>
                          </div>
                      </div>
                ...
                if(s.getGender().equals("1")){
                	%>
                	<td><input type="text" name="gender" style="font-family: serif; font-size: 15px; color: black;"  id="gender"  value="Female" placeholder=" your Gender" title="enter your password." disabled>       	
                <%}
                else{%>
                	  <td><input type="text" name="gender" style="font-family: serif; font-size: 15px; color: black;" id="gender" value="Male" placeholder=" your Gender" title="enter your password." disabled></td>
               <%  }
                %>
                      ...
                      <div class="form-group">
                          <div>
                             <label for="mobile"><h4>Age:</h4></label>
                              <input type="text"  name="age" style="font-family: serif; font-size: 15px;color: black; "  value="<%=s.getAge()%>" id="mobile" placeholder="enter mobile number" title="enter your mobile number if any." disabled>
                          </div>
                      </div> 
                      <div class="form-group">
                          ...
                          <div  class="col-xs-6">
                            <label for="password2"><h4>Height:</h4></label>
                              <input type="text"  name="height" style="font-family: serif; font-size: 15px;color: black; " value="<%=s.getCms()%> (cms)" id="dob" placeholder="Date of birth" title="enter your password2." disabled>
                          </div>
                      </div> 
                   ...
                   <div class="form-group">
                          ...
                          <div>
                            <label for="password2"><h4>Weight:</h4></label>
                              <input type="text" name="weight" style="font-family: serif; font-size: 15px;color: black; " value="<%=s.getWeight()%> (Kg)" id="dob" placeholder="Date of birth" title="enter your password2." disabled>
                          </div>
                      </div> 
                       <div class="form-group">
                          ...
                          <div  class="col-xs-6">
                            <label for="password2"><h4>Activeness:</h4></label>
                              <input type="text" name="active" style="font-family: serif; font-size: 15px;color: black;" value="<%=s.getActiveness()%>" id="dob" placeholder="Date of birth" title="enter your password2." disabled>
                          </div>
                      </div> 
                       <div class="form-group">
                          ...
                          <div>
                            <label for="password2"><h4>BMI:</h4></label>
                              <input type="text"  name="bmi" style="font-family: serif; font-size: 15px; color: black;" value="<%=s.getBmi()%>" id="dob" placeholder="Date of birth" title="enter your password2." disabled>
                          </div>
                      </div> 
                       <div class="form-group">
                          ...
                          <div  class="col-xs-6">
                            <label for="password2"><h4>Health:</h4></label>
                              <input type="text" name="health" style="font-family: serif; font-size: 15px;color: black; " value="<%=s.getMean()%>" id="dob" placeholder="Date of birth" title="enter your password2." disabled>
                          </div>
                      </div> 
                       <div class="form-group">
                          ...
                          <div>
                            <label for="password2"><h4>Calorie:</h4></label>
                              <input type="text" name="calorie" style="font-family: serif; font-size: 15px; color: black;" value="<%=s.getCalorie()%>" id="dob" placeholder="Date of birth" title="enter your password2." disabled>
                          </div>
                      </div> 
             ...
             <div class="form-group">
                          ...
                          <div>
                            <label for="password2"></label><input type="submit" value="Download Report" class="button" style="margin-left: 42%;"> 
                          </div>
                      </div> 
