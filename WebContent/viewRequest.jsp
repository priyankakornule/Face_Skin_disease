            ...
            <div class="container">
                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Face Skin Diease</a>
                    </div>

                    <!-- Collect the nav links, forms, and other content for toggling -->
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                            <li><a class="navactive color_animation" href="doctorwelcome.jsp">HOME</a></li>
...
<%
         ...
         System.out.println("UID======> : "+uid);          		
        			...
        			String first=r.getFname();
        			String last=r.getLname();
        			String email=r.getEmail();
                      String dis1=r.getDis();
                //  	System.out.print("Disease===>"+r.getDis()); 
  
   
   int aid=(int)session.getAttribute("aId");
   
   
   List<Appoinment> app=(List<Appoinment>)DataAccessLayer.requestAccept();
   
%>



<h1 align="center" style="margin-top: 10%;margin-left: 543px;">Analysis Report</h1>
	<br>
			...
			<form action="ViewRequestController" method="post">
				<table border="2"style="margin-top: 1%;    width: 60%;  margin-left: 25%; border-spacing: 10px 20px;"
					border="0" cellspacing="5" height="2">
                     ...
                     <th><b>Last Name</b></th>
                     <th><b>Disease Name</b></th>
                     <th><b>Status </b></th>
                    <%int count=1; %>
                       
                     <%
                     for(Appoinment ap:app){
                  	   String status=ap.getStatus();
                  	  // String dis2=ap.getDis();
					 ...
					 <tr>
						...
						<td><%=ap.getDis() %></td>
			<%System.out.print("Disease===>"+ap.getDis()); %>
			            
			             <%if(ap.getStatus().equals("Not Accepted")){%>
						<td><input type="submit" value="<%=ap.getStatus() %>" class="button" style=""></td>
						<%}else {%>
					...
					<%count++; %>
                  <%} %>
			 <!-- <tr style="font-size: 20px"></tr></td><td><input type="submit" value="Apponiment Request" class="button" style="margin-left: 42%;"></td>
      ...
      <!--   <section id ="beer" class="description_content">
       ...
       <!--  <footer class="sub_footer" style="    margin-top: 2%;">
            <div class="container">
