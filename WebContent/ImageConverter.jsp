...
%>
        ...
        <div id="top" class="starter_container6 bg">
            <div class="follow_container">
                <div class="col-md-6 col-md-offset-3">
                    <!--  <h3>Select Image</h3> -->
         <form id="form" action="GrayConversion" method="post">
          <fieldset>
          
              <!-- <input type="text" name="imgid" value:"Image Id:">
              <input type="submit" name="imgid" value="Select Image">
              <br class="clear">
            ...
            <div class="clear"></div>
            <div class="btns"><a data-type="reset" class="btn">Clear</a><span></span>
            
          <div class="btns"><a data-type="reset" class="btn">Clear</a>
          <span></span><a data-type="submit" class="btn" onclick="submit();" name="imgid">Submit</a> 
            
            	<tr align="center">
					<td> <font
						color="green"><button type="submit" name="submit" value="submit" style="
    margin-right: -146%;
    margin-top: 12%;
">Submit</button></font></td>
				</tr>
            	<center>-->


<h3 style="font-family: Lobster, serif; text-align: center; font-size: 60px;  "><%=request.getAttribute("Message")%></h3>
<br>
<a href="Predicition.jsp" style="font-family: Century Gothic; font-size: 30px; color: #191970;">Click Here </a><font size="5" style="font-family: Lobster, serif;font-size: 40px; ">To see the food predicted</font>
