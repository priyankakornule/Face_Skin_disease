...
<%@page import="com.DAO.*"%>
<%@page import="com.model.*,java.awt.image.BufferedImage"%>

<%@ page import="javax.imageio.ImageIO"%>
<%@ page import="java.io.*,java.sql.*,com.DAO.*"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1"%>
<%@ page import="com.data.Category"%>
<%@ page import="com.data.DataSet"%>  
<%@ page import="com.data.Instance"%> 	
<%@ page import="com.model.PredictionValues"%> 
...
%>
        ...
        <div id="top" class="starter_container1 bg">
            <div class="follow_container">
                <div class="col-md-6 col-md-offset-3">
                     ...
                     <%
      BufferedImage img = (BufferedImage) session.getAttribute("Image");
	...
	/*  String remi = null;
	 ...
	 <img src="data:image/jpg;base64, <%=b64%>" style="border-radius: 20px;" alt="Visruth.jpg not found" align="left"  />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<%-- <p class="formfield" vertical-align="middle" align="right"><font color: "#191970"; size: 100;><b>Disease Predicted:</b></font><%=predict%> </p> <textarea  rows="4" cols="40" font style=" style="border-radius: 20px; font-family:Yu Gothic UI;font-size:100; color:#191970; border-radius: 20px;""><%=predict%> </textarea> </p> --%>
	<h1 align="center">Analysis Report</h1>
	<table align="right" style="border-collapse: separate; width: 50%; border-spacing: 10px 20px;" border="0" cellspacing="5" height="2">
	<tr style="font-size: 20px"><td> <b>Status:</b>  </td>
	<%
	String status=null;
	if(predict.equals("Healthy")) 
	{ 
	...
	<tr style="font-size: 20px"><td> <b>Disease Name:</b>  </td><td> <%=predict%> </td></tr>
	

	
	<%-- <tr style="font-size: 20px"><td> <b>Remedies:</b>  </td>
	<td> <%=remi %> </td></tr> --%>
    </table>
	...
	<%
	  ...
	  String update="UPDATE user_uploaded_images SET prediction=' "+predict+ " ' WHERE file_id= "+id;
